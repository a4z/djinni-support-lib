...
""" Download djinni generator as specified in generator.cfg

    Downloading the release or pre-release is easy, just use the GitHub API to get the latest release
    ...
    8. Unzip the file
    9. Make the file executable (on Linux and Mac, rename on Windows)

    For this, the GENERATOR_DL_TOKEN environment variable needs to be set to a GitHub personal access token

"""

dl_arg = None

with open('generator.cfg', 'r') as file:
...
if not dl_arg:
    sys.exit('No generator argument found')
